...
$id_sub = (int)$id_sub;
  ...
  CONNECT_DB();
    ...
    $sql='SELECT `serial_meter`, `name_meter`, `unit_meter`, `count_point_meter`, `level_meter`, `relation_meter`, `online_status`  FROM `meter` WHERE `id_sub` = '.$id_sub.' ORDER BY `relation_meter` DESC';
